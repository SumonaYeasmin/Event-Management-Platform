          ...
          return (
            ...
            >
              ...
              <img
                src={event.image}
                alt={event.title}
                // className="w-full md:w-36 h-40 md:h-24 rounded-xl object-cover bg-slate-100 shrink-0"
                className="w-full lg:w-36 h-40 lg:h-24 rounded-xl object-cover bg-slate-100 shrink-0"
              />
