      ...
      <div className="space-y-4">
        {adminEvents.map((event) => {
          ...
          return (
            <div
              key={event.id}
              // className="bg-white p-3 md:p-4 lg:p-5 rounded-xl md:rounded-2xl border border-slate-100 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col md:flex-row items-start md:items-center gap-5"
              className="bg-white p-3 md:p-4 lg:p-5 rounded-xl md:rounded-2xl border border-slate-100 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col lg:flex-row items-start lg:items-center gap-5"
            >
              <img
                src={event.image}
                alt={event.title}
                // className="w-full md:w-40 h-40 md:h-36 lg:h-40 rounded-xl object-cover bg-slate-100 shrink-0"
                className="w-full lg:w-40 h-40 lg:h-36 xl:h-40 rounded-xl object-cover bg-slate-100 shrink-0"
              />
              ...
              <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto justify-start lg:justify-end shrink-0">
                {isPending ? (
                  ...
                  <>
                    <button className="border border-slate-200 hover:bg-slate-50 text-slate-600 transition-colors text-xs font-semibold px-3 lg:px-3.5 py-2 rounded-lg flex items-center gap-1.5 cursor-pointer">
                      <Eye className="h-3.5 w-3.5 text-slate-400" />
                      View
                    </button>
                    {isPublished && (
                      <button className="border border-amber-200 hover:bg-amber-50 text-amber-600 transition-colors text-xs font-semibold px-3 lg:px-3.5 py-2 rounded-lg flex items-center  gap-1.5 cursor-pointer">
